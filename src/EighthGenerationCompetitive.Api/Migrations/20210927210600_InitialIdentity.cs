    ...
    public partial class InitialIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Nintendo3dsFriendCode = table.Column<string>(type: "varchar(14)", maxLength: 14, nullable: true),
                    NintendoSwitchFriendCode = table.Column<string>(type: "varchar(17)", maxLength: 17, nullable: true),
                    ShowdownNickname = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true),
